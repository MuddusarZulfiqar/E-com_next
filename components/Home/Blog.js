      ...
      <div className="row">
        <div className="col-md-4">
          <div className="blogCard">
            <Link href="#">
              <a className="blogCard__link" title="link">
                <i className="fa fa-link" aria-hidden="true"></i>
              </a>
            </Link>
            <div className="blogCard__image">
              <img src="assets/home/product.png" />
            </div>
            <div className="blogCard__detail">
              <h4 className="blogCard__detail--title">
                Lorem ipsum dolor sit amet
              </h4>
              <div className="blogCard__detail--info">
                some text <span>Same</span>
              </div>
              <p className="blogCard__detail--detail">
              ...
              <button className="btn btn-border-theme text-black">
                Read more
              </button>
            </div>
          </div>
